  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <p className="text-lg mb-4">
        <span className="font-bold">Helmy Estate</span> is a modern real estate
        marketplace designed and built using the{' '}
      ...
      <p className="text-lg mb-4">
        ...
        and deployment, along with <span className="font-bold">ESLint</span> and{' '}
        <span className="font-bold">Prettier</span> for code linting and
        formatting.
      </p>
      <p className="text-lg mb-4">
